...
{
TutorialsList1.Add(new Items { Id = int.Parse(App.no[i]), Name = App.time[i].ToString()+"	"+App.time[(i+1)].ToString(), Url = "https://codeuniverse.net/japanese/words/time/s" + App.no[i].ToString() + ".mp3" });
            }
        }
