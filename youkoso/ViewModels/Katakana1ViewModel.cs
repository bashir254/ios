...
public partial class Katakana1ViewModel : BaseViewModel
{
...
{
TutorialsList1.Add(new Items { Id = int.Parse(App.no[i]), Name = App.k1[i].ToString()+"."+App.k1[(i+1)].ToString(), Url = "https://codeuniverse.net/japanese/characters/s1/s" + App.no[i].ToString() + ".mp3" });
            }
        }
