...
public partial class GreetingViewModel : BaseViewModel
{
...
{
TutorialsList1.Add(new Items { Id = int.Parse(App.no[i]), Name = App.greeting[i].ToString()+"	"+App.greeting[(i+1)].ToString(), Url = "https://codeuniverse.net/japanese/words/greeting/s" + App.no[i].ToString() + ".mp3" });
            }
        }
