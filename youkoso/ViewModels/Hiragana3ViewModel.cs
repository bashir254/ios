...
public partial class Hiragana3ViewModel : BaseViewModel
{
...
{
TutorialsList1.Add(new Items { Id = int.Parse(App.no[i]), Name = App.h3[i].ToString()+"."+App.h3[(i+1)].ToString(), Url = "https://codeuniverse.net/japanese/characters/s3/s" + App.no[i].ToString() + ".mp3" });
            }
        }
