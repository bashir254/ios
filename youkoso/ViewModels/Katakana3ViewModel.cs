...
public partial class Katakana3ViewModel : BaseViewModel
{
...
{
TutorialsList1.Add(new Items { Id = int.Parse(App.no[i]), Name = App.k3[i].ToString()+"."+App.k3[(i+1)].ToString(), Url = "https://codeuniverse.net/japanese/characters/s3/s" + App.no[i].ToString() + ".mp3" });
            }
        }
