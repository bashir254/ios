...
public partial class Hiragana2ViewModel : BaseViewModel
{
...
{
TutorialsList1.Add(new Items { Id = int.Parse(App.no[i]), Name = App.h2[i].ToString()+"."+App.h2[(i+1)].ToString(), Url = "https://codeuniverse.net/japanese/characters/s2/s" + App.no[i].ToString() + ".mp3" });
            }
        }
