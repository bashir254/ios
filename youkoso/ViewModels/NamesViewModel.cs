...
public partial class NamesViewModel : BaseViewModel
{
...
{
TutorialsList1.Add(new Items { Id = int.Parse(App.no[i]), Name = App.names[i].ToString()+"	"+App.names[(i+1)].ToString(), Url = "https://codeuniverse.net/japanese/words/names/s" + App.no[i].ToString() + ".mp3" });
            }
        }
