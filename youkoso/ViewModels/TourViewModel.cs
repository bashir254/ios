...
public partial class TourViewModel : BaseViewModel
{
    [ObservableProperty]
    string text;
...
public TourViewModel()
{
    ...
    async Task Lessons()
    {
            ...
            {
WebViewModel.tutorialUrl = "https://codeuniverse.net/japanese/services/tour.html";
...
if (Microsoft.Maui.ApplicationModel.Communication.Email.Default.IsComposeSupported)
{
    ...
    string subject = "طلب السياحة باليابان";
    string body = text;
