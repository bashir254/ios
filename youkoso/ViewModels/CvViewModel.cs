...
public partial class CvViewModel : BaseViewModel
{
    [ObservableProperty]
    string text;
...
public CvViewModel()
{
    ...
    async Task Lessons()
    {
            ...
            {
WebViewModel.tutorialUrl = "https://codeuniverse.net/japanese/services/cv.html";
...
if (Microsoft.Maui.ApplicationModel.Communication.Email.Default.IsComposeSupported)
{
    ...
    string subject = "طلب إنشاء سيرة ذاتية";
    string body = text;
